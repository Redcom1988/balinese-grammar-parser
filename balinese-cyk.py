...
def main():
    ...
    # Basic sentence structures including S P O patterns
        ...
        "Pel -> PP NP | NP PP | Adj PP | NumP PP",
        "O -> NP | Verb | NP AdjP",
        "Ket -> PP | PP PP | Adv | PP NP",
        
        # Phrase structures
        "NP -> Noun | PropNoun | Pronoun | Det NP | NP Noun | NP PropNoun | NP Det | NP Adj | NP NumP | Noun Pronoun | Pronoun Pronoun",
        "PP -> Prep | Prep NP | PP AdvP",

        "VP -> SimpleVP | ComplexVP | AuxVP", 
        "SimpleVP -> Verb", 
        "ComplexVP -> Verb Verb", 
        "AuxVP -> Aux SimpleVP", 
        "AdjP -> Adj | Adj Adv",
        ...
        "Aux -> dados | sesai | prasida | dadi | sesai | sampun | pisan | paling | sane | setata",
        "Adv -> tuni | semengan | ibi | sanja | taun | wai | semeng | peteng | sue | pisan",
        "Noun -> carik | padi | sekolah | sepeda | kantor | desa | kampus | tukang | pasar | dosen | nasi | ajengan | siap | ukud | baju | mahasiswa | olahraga | balian | komputer | sepatu | kota | motor | umah | olahraga",
        "PropNoun -> i | putu | dangin | wayan | darta | gede | kampus | udayana | jimbaran | tukad | unda | yogyakarta | ketut | bagus | guru",
        "Pronoun -> titiang | tiang | tiange | adin | adine | bapakne | bapane | bapan | dane | memene | ragane | timpal | timpalne | adik | sepedane | ketua | ipune",
        "Det -> punika | ento",
        "Adj -> galak | jegeg | sane | demenin | paling | akeh | luung | gati | baru | sakti",
        "Verb -> melajah | kapah | melali | anggone | rauh | mekarya | manting | meblanja | dados | ngatehin | nanem | megambal | pinaka",
